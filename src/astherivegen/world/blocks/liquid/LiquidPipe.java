    ...
    public class LiquidPipeBuild extends GenesisLiquidBuild{
        ...
        boolean blends(Tile other){
            if(other != null && other.build != null){
                if(other.build instanceof LiquidPipeBuild || (other.build.block instanceof PipePump && (tile.x = other.x+Geometry.d4(other.build.rotation).x*-1) && (tile.y = other.y+Geometry.d4(other.build.rotation).y*-1))){
                    return true;
                }
            }
            return false;
