...
public class Pathfinder implements Runnable{
    ...
    //none (flat cost)
    (team, tile) -> 1 +
    //none...EXCEPT for DEADZONE mwAHAHAHAHAHAHHA
    (Pathtile.deadzoneAmount(tile)),
    ...
    public int packTile(Tile tile){
        ...
        for(int i = 0; i < 4; i++){
            ...
            if(other != null){
                ...
                deadzoneAmount = deadzone.find(t -> t._1.equals(input)).map(t -> t._2).getOrElse(0f);
            }
        }
    ...
    class PathTileStruct{
        ...
        //some random variable thats trying to fit in
